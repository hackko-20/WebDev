...
class Profile(models.Model):#list of members
	...
	mem_username=models.TextField(max_length=30,blank=True,null=True)
	memberpin=models.TextField(max_length=4,blank=True,null=True)
	...
	ctask_jan = models.IntegerField(default=0)
	ctask_feb = models.IntegerField(default=0)
	ctask_mar = models.IntegerField(default=0)
	ctask_apr = models.IntegerField(default=0)
	ctask_june = models.IntegerField(default=0)
	ctask_july = models.IntegerField(default=0)
	ctask_aug = models.IntegerField(default=0)
	ctask_sept = models.IntegerField(default=0)
	ctask_oct = models.IntegerField(default=0)
	ctask_may = models.IntegerField(default=0)
	ctask_nov = models.IntegerField(default=0)
	ctask_dec = models.IntegerField(default=0)
